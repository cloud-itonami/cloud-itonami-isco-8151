...
2. Define consent and purpose categories for spinner/mill records.
...
- safety-critical escalation path (entanglement hazard, fibre-dust
  exposure, equipment condition)
- provenance for all operating records (spinner and mill both
